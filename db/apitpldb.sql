...
--
-- Host: localhost
-- Generation Time: 2017-11-13 20:45:39
-- 服务器版本： 5.6.26
-- PHP Version: 5.6.30
...
CREATE TABLE IF NOT EXISTS `adminuser` (
  ...
  `allowance` int(10) NOT NULL DEFAULT '0' COMMENT '剩余请求数',
  `allowance_updated_at` int(10) NOT NULL DEFAULT '0' COMMENT '请求数更新时间'
...
INSERT INTO `adminuser` (`id`, `username`, `realname`, `email`, `status`, `password_hash`, `auth_key`, `password_reset_token`, `access_token`, `expire_at`, `logged_at`, `created_at`, `updated_at`, `allowance`, `allowance_updated_at`) VALUES
(1, 'weixi', '魏曦', 'weixistyle@qq.com', 10, '$2y$13$HtJqGRmc76KIRIwokii8AOQ1XZljXiuWCKUGFnH9vkTnfBpHtqgFu', 'pG7TRyTIXlEbcenpi34TzmMYS2zDsMTF', NULL, 'Hlq53Bbjod8H5P43pRa6rGXE2tSvprF1', 1507864985, 1505998873, 1505998873, 1507452183, 2, 1507452183),
(2, 'heyx', '何泳筱', 'heyx@weixistyle.com', 10, '$2y$13$HtJqGRmc76KIRIwokii8AOQ1XZljXiuWCKUGFnH9vkTnfBpHtqgFu', 'IXlEbcenpi34TzmMpG7TRTFyTYS2zDsM', '1', 'zcnzqvD4aFnvroJr5twlsVmoP1izYBcb', 1511146193, 1505998873, 1505998873, 1510541393, 2, 1508581003),
(3, 'guojin', '郭靖', 'guojin@qq.com', 10, '$2y$13$P.jcWALywm9rjg7XyEOEDeEU3xZEZm9MBh7UsNiAXNoxSjoOSkWMu', 'gt8-DPqtZf_jxnwB0-mEyZ_PZBGKePpv', NULL, NULL, NULL, NULL, 1506508474, 1506508474, 0, 0),
(4, 'huangrong', '黄蓉', 'huangrong@qq.com', 10, '$2y$13$sUaDfAI3yU8CAAMnCrPfMuhih6v5rJ.itjAtAoHaQAlpYuX/WZDAK', 'SkRjGG0hxcnkX8ywyNCjT36wxt8b5HU-', NULL, NULL, NULL, NULL, 1507282163, 1507282163, 0, 0);
...
(6, '讲师介绍', '魏曦从事技术开发和技术管理，有超过10年的经验，擅长的技术是PHP和iOS开发，负责开发了校园网软件、在线教育平台、在线旅游平台、连锁酒店系统、电商平台等多个大中型项目。', 1, 10, 1, 1504752766, 1504752766),
...
('ArticleAdmin', '1', 1507127767),
('ArticleViewer', '2', 1507127782);
...
('/article/*', 2, NULL, NULL, NULL, 1507127580, 1507127580),
('/article/view', 2, NULL, NULL, NULL, 1507127592, 1507127592),
('ArticleAdmin', 2, '文章管理', NULL, NULL, 1507127718, 1507127718),
('ArticleViewer', 2, '文章查看', NULL, NULL, 1507127681, 1507127681);
...
('m140506_102106_rbac_init', 1507115142);
